...
def test_rewrite_file_json():  #  Тест функции перезаписи файла json формата из нормального вида
    real_name = {'Пополнение счета_1': 1000, 'Пополнение счета_1_+': 5000, 'Покупка_1-a': 1000, 'Покупка_1-a_+': 1000, 'Пополнение счета_2': 3000, 'Пополнение счета_2_+': 7000, 'Покупка_2-as': 500, 'Покупка_1-zxcv': 4000, 'Покупка_1-zxcv_+': 4000}
...
def test_addition_dict():   # Тест функции прибавления словаря текущей истории к словарю общей истории
    ...
    common_history = {'Пополнение счета_1': 5000, 'Пополнение счета_2': 34789, 'Покупка_1-weryu': 1235, 'Покупка_2-xcv': 2346,
               'Пополнение счета_3': 7000, 'Пополнение счета_5': 5000, 'Пополнение счета_6': 34789, 'Покупка_7-weryu': 1235, 'Покупка_8-xcv': 2346, 'Пополнение счета_9': 7000}
...
def test_read_pickle():                  # Тест функции считывания инфы из файла в байтах и перевода в нормальный вид
    date = {'Пополнение счета_1': 1000, 'Пополнение счета_1_+': 5000, 'Покупка_1-a': 1000, 'Покупка_1-a_+': 1000, 'Пополнение счета_2': 3000, 'Пополнение счета_2_+': 7000, 'Покупка_2-as': 500, 'Покупка_1-zxcv': 4000, 'Покупка_1-zxcv_+': 4000}
